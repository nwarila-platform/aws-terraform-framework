...
# subnet-west-c lives in the second zone; the provider mock answers us-east-1a for every other subnet.
override_data {
...
# subnet-west-inventory-refresh lives in the second zone; the provider mock answers us-east-1a for every other subnet.
override_data {
...
# subnet-west-ebs-refresh lives in the second zone; the provider mock answers us-east-1a for every other subnet.
override_data {
