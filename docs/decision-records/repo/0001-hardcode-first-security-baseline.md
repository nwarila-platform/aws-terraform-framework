...
| Consulted        | Fable and Sol dual-auditor architecture analysis.                           |
...
4. **The documented enforcement path must be real.** Fable and Sol independently
   preferred the B1 design--definition in the framework, enforcement in
   consumers, and a mocked repository self-gate--if consumers actually ran it.
   Both auditors also identified the same caveat: no consumer evaluates the
...
| ---------- | -------------------------------------------------- | --------------------------------------------- | -------------------- | ---------- |
| 2026-07-22 | Accepted the hardcode-first security baseline ADR. | Record the Director's T19 enforcement ruling. | Portfolio maintainer | Yes        |
